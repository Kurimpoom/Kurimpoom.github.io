...
- ## 2.3DFT的应用
  ...
  **2.用DFT计算卷积可能还不如直接进行卷积运算来得快**  
  ...
  -  ### 利用DFT对连续信号进行频谱分析
   ...
   <img src="https://s1.ax1x.com/2023/07/20/pCHEWlt.jpg">
	...
	- #### 利用DFT对连续时间信号进行频谱分析的过程
	 ...
	 大致的过程上面已经讲过，这里放张图，帮助回忆。
	 <img src="https://s1.ax1x.com/2023/07/20/pCHmm7T.png">
	  
	- #### 利用DFT对连续时间信号进行近似频谱分析中的问题以及解决方法
  ...
  ①.**频谱泄漏**
  无限长的序列加矩形窗截断后，在矩形窗频谱函数的作用下，使得X<sub>N</sub>(e<sup>jω</sup>)出现较大的**频谱扩展**和向两边的波动，通常称之为频谱泄漏或功率泄漏，给频率分析带来了误差，使得频率分辨率降低。当一个大信号和小信号频率相近时，会淹没掉小信号。  
  ...
  **2.选用副瓣较小的窗函数**  
  ...
  信号的持续时间Tp应满足频率分辨率的要求，即Tp=1/Δf，即长的信号采样持续时间会得到较高的频率分辨率（Δf越小）
